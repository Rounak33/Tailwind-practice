  ...
  return (
    <div className='flex gap-4 text-white justify-between items-center h-24 max-w-[1240px] mx-auto px-4'>
        ...
        <ul className='hidden md:flex'>
            <li className="p-4 hover:text-[#8cecff] cursor-pointer"> Home </li>
            <li className="p-4 hover:text-[#8cecff] cursor-pointer"> Company </li>
            <li className="p-4 hover:text-[#8cecff] cursor-pointer"> Resources </li>
            <li className="p-4 hover:text-[#8cecff] cursor-pointer"> Resources </li>
            <li className="p-4 hover:text-[#8cecff] cursor-pointer"> Contact </li>
